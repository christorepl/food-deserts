...
export default class SavePage extends React.Component {
    ...
    render() {
        let currentSave = this.context.userSaves.find(saves => saves.save_name === this.props.match.params.save_name);
        ...
        <div className='save-data'>
            <h1>{currentSaveName}</h1>
                <fieldset>
                    ...
                    <form className="forms" onSubmit={(e) => this.context.updateSaveName(e, currentSaveName)}>
                    ...
                    <div className="forms">
                        ...
                        <div className="delete-save-button">
                            <button type="submit" onClick={(e) => this.context.deleteSave(currentSaveName, e)}>Delete this save</button>
                        </div>
                    </div>
                </fieldset>
        </div>
