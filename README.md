...
User can search for one or more states and view the numbers or can opt to view charts of the same data. Visual aids for data helps users to more quickly compare data of the selected states.
